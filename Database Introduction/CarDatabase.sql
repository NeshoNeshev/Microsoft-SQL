...
INSERT INTO Cars (PlateNumber, Manufacturer, Model, CarYear, CategoryId, Doors, Picture, Condition, Available)
	VALUES ('A 80 60 BB', 'Mazda', '3', '2020-01-03', 2, 5, 2020, 'NEW', 'Y'),
	       ('A 80 40 BB', 'Mazda', '3', '2020-12-01', 3, 2, 2010, 'NEW', 'N'),
	       ('A 80 50 BB', 'Mazda', '3', '2020-11-03', 1, 5, 2011, 'NEW', 'Y')

INSERT INTO Employees(FirstName, LastName, Title, Notes)
	VALUES ('Ivan', 'Ivanov', 'Programmer', 'Hello!'),
		   ('Ivan', 'Petrov', 'Salesman', 'Hello!'),
		   ('Georgi', 'Angelov', 'PoliceOficer', 'Hello!')

INSERT INTO Customers (DriverLicenceNumber, FullName, [Address], City, ZIPCode, Notes)
	VALUES ('1561A', 'Georgi Georgiev', 'Bv. 315', 'Sofia', 55555, ':)'),
		   ('15161C', 'Ivan Ivanov', 'Bv. 31155', 'Burgas', 51255, ':)'),
		   ('15651B', 'Petar Petrov', 'Bv. 317675', 'Plovdiv', 593555, ':)')
...
INSERT INTO RentalOrders (EmployeeId, CustomerId, CarId, TankLevel, KilometrageStart, KilometrageEnd, StartDate, EndDate, RateApplied, TaxRate, OrderStatus)
	VALUES (2, 1, 3, 125, 104512, 670123, '2015-05-12', '2018-07-10', 10723.65, 85126.56, 'Delivered'),
